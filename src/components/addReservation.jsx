...
const AddReservation = () => {
  ...
  return (
    ...
    <div className="h-full w-full p-5 md:px-20 bg-cover  bg-no-repeat bg-[url('./images/bgreflect.png')] bg-gray-600 bg-blend-multiply rounded-md">
      ...
      <div class="mb-6">
        <label for="email" className="block mb-2 text-sm font-semibold text-white dark:text-white">Bike Name</label>
      ...
      <div class="mb-6">
        <label for="email" className="block mb-2 text-sm font-semibold text-white dark:text-white">Date</label>
      ...
      <div class="mb-6">
        <label for="email" className="block mb-2 text-sm font-semibold text-white dark:text-white">Number</label>
      ...
      <div class="mb-6">
        <label for="email" className="block mb-2 text-sm font-semibold text-white dark:text-white">City Name</label>
