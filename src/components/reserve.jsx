    ...
    return (
      <div key={reserve.id} className='flex flex-row reserve'>
        ...
        <div className='flex flex-col reserve-right'>
          <h4> <b>Date:</b> <span className='ml-1'>{reserve.date_of_reservation}</span></h4> 
          <h4> <b>City:</b> <span className='ml-1'>{reserve.city}</span></h4> 
          <h4><b>Duration of test drive:</b> <span className='ml-1'>{reserve.duration_of_test_drive} minutes.</span></h4> 
        </div>
      </div>
    );
  }
